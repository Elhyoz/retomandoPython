...
class Nota:
     ...
     def __init__(self, memo, tags=''):
         '''Inicializa una nota con un memo y opcional tags
     ...
     def match(self, filter):
         ...
         Devuelve True si concuerda, en otro caso False.
         Búsqueda es case sensitive y compara tanto con text
         como con tags'''
...
class Cuaderno:
    ...
    def modificar_memo(self, nota_id, memo):
        '''Encuentra la nota con la id dada y cambia su memo 
        al valor dado'''
        nota = self._encontrar_nota(nota_id).memo = memo
        if nota:
            nota.memo = memo
            return True
        return False
    ...
    def modificar_tags(self, nota_id, tags):
        '''Encuentra la nota con la id dada y cambia sus tags
        al valor dado'''
        nota = self._encontrar_nota(nota_id).tags = tags
        if nota:
            nota.tags = tags
            return True
        return False
    ...
    def _encontrar_nota(self, nota_id):
        ...
        for nota in self.notas:
            if nota.id == nota_id:
                return nota
            return print("No hay no existe prro")
